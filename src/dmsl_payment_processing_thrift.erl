...
-export_type([
    ...
    'RecurrentPaytoolPredestination'/0,
    'RecurrentPaymentPredestination'/0,
    'InvalidStatus'/0,
    'InvoiceUnpayable'/0,
...
-type struct_name() ::
    ...
    'RecurrentPaytoolPredestination' |
    'RecurrentPaymentPredestination' |
    'InvalidStatus' |
    'InvoiceUnpayable' |
...
-type 'RejectedRoute'() :: #'payproc_RejectedRoute'{}.
...
-type 'Predestination'() ::
    {'payment', 'PaymentPredestination'()} |
    {'recurrent_paytool', 'RecurrentPaytoolPredestination'()} |
    {'recurrent_payment', 'RecurrentPaymentPredestination'()}.

%% struct 'PaymentPredestination'
-type 'PaymentPredestination'() :: #'payproc_PaymentPredestination'{}.

%% struct 'RecurrentPaytoolPredestination'
-type 'RecurrentPaytoolPredestination'() :: #'payproc_RecurrentPaytoolPredestination'{}.

%% struct 'RecurrentPaymentPredestination'
-type 'RecurrentPaymentPredestination'() :: #'payproc_RecurrentPaymentPredestination'{}.
...
struct_info('Predestination') ->
    {struct, union, [
        {1, optional, {struct, struct, {dmsl_payment_processing_thrift, 'PaymentPredestination'}}, 'payment', undefined},
        {2, optional, {struct, struct, {dmsl_payment_processing_thrift, 'RecurrentPaytoolPredestination'}}, 'recurrent_paytool', undefined},
        {3, optional, {struct, struct, {dmsl_payment_processing_thrift, 'RecurrentPaymentPredestination'}}, 'recurrent_payment', undefined}
    ]};

struct_info('PaymentPredestination') ->
    {struct, struct, []};

struct_info('RecurrentPaytoolPredestination') ->
    {struct, struct, []};

struct_info('RecurrentPaymentPredestination') ->
    {struct, struct, []};
...
record_name('RejectedRoute') ->
    'payproc_RejectedRoute';
...
record_name('PaymentPredestination') ->
    'payproc_PaymentPredestination';

record_name('RecurrentPaytoolPredestination') ->
    'payproc_RecurrentPaytoolPredestination';

record_name('RecurrentPaymentPredestination') ->
    'payproc_RecurrentPaymentPredestination';
