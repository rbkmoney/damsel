...
-type 'InvoicePaymentChangePayload'() ::
    ...
    {'invoice_payment_limit_checked', 'InvoicePaymentLimitChecked'()}.
...
-type 'InvoicePaymentLimitChecked'() :: #'payproc_InvoicePaymentLimitChecked'{}.
...
struct_info('InvoicePaymentChangePayload') ->
    {struct, union, [
        ...
        {16, optional, {struct, struct, {dmsl_payment_processing_thrift, 'InvoicePaymentLimitChecked'}}, 'invoice_payment_limit_checked', undefined}
    ]};
...
record_name('InvoicePaymentLimitChecked') ->
    'payproc_InvoicePaymentLimitChecked';
