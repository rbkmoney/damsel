...
service PayoutManagement {
    ...
    **/
    ...
    /**
     * Сгенерировать и отправить по почте отчет по выплатам резидентам
     */
    void SendResidentsReport(1: set<PayoutID> payout_ids) throws (1: base.InvalidRequest ex1)

    /**
     * Сгенерировать и отправить по почте отчет по выплатам нерезидентам
     */
    void SendNonResidentsReport(1: set<PayoutID> payout_ids) throws (1: base.InvalidRequest ex1)
}
